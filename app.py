...
# -*- coding: utf-8 -*-
"""
COPAR Web - Versão Simples
Apenas login por matrícula e consulta de dados
"""
...
app = Flask(__name__)
app.secret_key = 'copar-simples-2024'
...
def buscar_estoque(produtor_id):
    """Busca todo o estoque atual do produtor"""
    conn = conectar_banco()
    if not conn:
        return []
...
def calcular_saldos(vendas):
    """Calcula total recebido e a receber"""
    total_recebido = 0
    total_a_receber = 0
